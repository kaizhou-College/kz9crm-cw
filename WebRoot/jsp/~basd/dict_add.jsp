...
<table class="query_form_table">
	<tr>
		...
		<th>类别</th>
		<td><input type="text" id="dictType" /><span class="red_star">*</span><br /></td>
	</tr>
	<tr>
		<th>条目</th>
		<td><input type="text" id="dictItem" /><span class="red_star">*</span></td>
		<th>值</th>
		<td><input type="text" id="dictValue" /><span class="red_star">*</span></td>
	</tr>	
	<tr>
		<th>是否可编辑</th>
		<td><input type="checkbox" id="editable" /></td>
		<th>&nbsp;</th>
		<td></td>
	</tr>
</table>
