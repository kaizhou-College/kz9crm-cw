...
<table class="data_list_table">
	...
	<tr>
		...
		<td class="list_data_op">
			　</td>
		<td class="list_data_op">
			<img onclick="to('activities_edit.html');" title="编辑" src="${basePath}/images/bt_edit.gif" class="op_button" />
			<img onclick="del('“交往记录：签订意向协议”');" title="删除" src="${basePath}/images/bt_del.gif" class="op_button" />
