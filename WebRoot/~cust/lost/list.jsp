	...
	<c:forEach items="${list}" var="list">
		<tr align="center">
			...
			<td class="list_data_op">
				<img onclick="to('custLostSel_SelById?cstl.lstId=${list.lstId}');" title="确认流失" src="images/bt_confirm.gif" class="op_button" />
				<img onclick="to('custLostSel_SelByIdT?cstl.lstId=${list.lstId}');" title="暂缓流失" src="images/bt_relay.gif" class="op_button" />
			</td>
	</tr>
	</c:forEach>
	<tr>
